...
func TestSortRouter(t *testing.T) {
	...
	if strings.Join(paths, ",") != strings.Join([]string{"/api/orders/new", "/api/orders/:order_id", "/api/orders/:order_id/order_items", "/api/orders/:order_id/order_items/new", "/api/orders/:order_id/order_items/:order_item_id"}, ",") {
